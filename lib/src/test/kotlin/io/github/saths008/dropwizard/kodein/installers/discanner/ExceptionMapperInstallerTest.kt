...
import io.github.saths008.dropwizard.kodein.installers.autoscanner.ResourceInstaller
import io.github.saths008.dropwizard.kodein.installers.autoscanner.TestConfiguration
import io.github.saths008.dropwizard.kodein.installers.discanner.ExceptionMapperInstallerTest.Companion.scanResults
import io.github.saths008.dropwizard.kodein.resources.AnotherResource
import io.github.saths008.dropwizard.kodein.resources.BlahResource
    ...
    companion object {
        ...
        val scanResults =
            ClassGraph()
                ...
                .acceptPackages("io.github.saths008.dropwizard.kodein.resources")
                .scan()
    }
...
class ExceptionMapperTestApplication : Application<TestConfiguration>() {
    override fun run(
        ...
        val di =
            DI {
                bindSingleton<NotFoundExceptionMapper>(tag = NotFoundExceptionMapper::class.java.name) {
                ...
                bindSingleton<AnotherResource>(tag = AnotherResource::class.java.name) {
                    AnotherResource()
                }
            }
